...
const beforeAfterImages = [
  { before: '/api/generate-image/1', after: '/api/generate-image/2', treatment: 'Blanqueamiento Dental' },
  { before: '/api/generate-image/3', after: '/api/generate-image/4', treatment: 'Ortodoncia' },
  { before: '/api/generate-image/5', after: '/api/generate-image/6', treatment: 'Carillas de Porcelana' },
];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-purple-50 to-indigo-50 relative overflow-x-hidden">
            ...
            <div className="scroll-animate opacity-0" style={{ animationDelay: '0.2s' }}>
              <Card>
                <CardContent className="p-8 text-center flex flex-col items-center">
                  ...
                  <p className="text-gray-600 leading-relaxed text-base">
                    Corrección de alineación dental con tratamientos personalizados para una sonrisa perfecta.
                  </p>
                </CardContent>
              </Card>
            </div>
              ...
              <div key={index} className="scroll-animate opacity-0" style={{ animationDelay: `${index * 0.2}s` }}>
                <Card className="overflow-hidden p-0 gap-0">
                  ...
                  <div className="p-4 bg-white/50 text-center">
                    <p className="font-semibold text-gray-700">{img.treatment}</p>
                  </div>
                </Card>
              </div>
            ))}
      ...
      <section id="contacto" className="py-20 md:py-28 bg-gradient-to-br from-purple-600 via-rose-600 to-indigo-600 text-white relative z-10">
        <div className="container mx-auto px-4 text-center">
          <Badge className="mb-6 glassmorphism text-white/90 bg-white/10 border-white/30 hover:bg-white/20 px-6 py-3 text-sm md:text-base font-medium scroll-animate opacity-0">
            <Sparkles className="w-4 h-4 mr-2" />
            Tu Sonrisa Perfecta te Espera
          </Badge>

          <h2 className="text-4xl md:text-6xl font-extrabold mb-6 scroll-animate opacity-0" style={{ animationDelay: '0.2s' }}>
            ¿Listo para Transformar
            <span className="block text-3xl md:text-5xl text-rose-200 drop-shadow-lg">Tu Sonrisa?</span>
          </h2>

          <p className="text-xl md:text-2xl mb-12 text-white/90 max-w-3xl mx-auto scroll-animate opacity-0" style={{ animationDelay: '0.4s' }}>
            Agenda tu cita hoy y descubre por qué somos la mejor opción para tu salud dental
          </p>

          <div className="flex flex-col sm:flex-row gap-6 justify-center scroll-animate opacity-0" style={{ animationDelay: '0.6s' }}>
            <Button
              size="lg"
